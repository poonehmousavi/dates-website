...
export default function AcousticLMBenchmarks() {
      ...
      <tbody>
        ...
        <tr><td>WT-SMA-24</td><td className="text-center">1</td><td className="text-center">51.26</td><td className="text-center">53.31</td><td className="text-center">51.25</td><td className="text-center">51.46</td><td className="text-center">82.5</td><td className="text-center">71.0</td><td className="text-center">75.5</td><td className="text-center">50.0</td></tr>
            ...
            <div className="text-base text-gray-700 dark:text-gray-900 max-w-4xl mx-auto text-left bg-gray-50 p-4 rounded  mt-6">
              ...
              Our study reveals that semantic and acoustic performance in SLMs varies significantly across tokenizer types. HuBERT remains the strongest performer on semantic tasks, while WavLM leads in acoustic consistency. Hybrid tokenizers, particularly those with semantic stream overweighting, showed promising results by narrowing the semantic gap with HuBERT and outperforming it on acoustic benchmarks. These gains, however, come with trade-offs, emphasizing the importance of carefully balancing semantic and acoustic objectives. Overall, our findings suggest that, for now, there is no single tokenizer that excels across all tasks, underscoring the need to thoughtfully select the tokenizer and training configuration based on the target application, as different tokenizers prioritize different aspects of speech modeling.            </div>
          </div>
        </details>
  ...
  <div className="overflow-x-auto p-4 bg-white text-black mt-4">
    <table className="table-auto min-w-full border border-gray-300 text-sm">
      ...
      <tbody>
        <tr><td>Enc-SMA-24</td><td className="text-center">8</td><td className="text-center">2.65</td><td className="text-center">40.91</td><td className="text-center">0.89</td></tr>
        <tr><td>DAC-SMA-24</td><td className="text-center">8</td><td className="text-center">2.73</td><td className="text-center">42.86</td><td className="text-center">0.86</td></tr>
        <tr><td>ST-S-16</td><td className="text-center">8</td><td className="text-center"><u>3.27</u></td><td className="text-center"><u>14.29</u></td><td className="text-center"><b>0.90</b></td></tr>
        <tr><td>Mimi-S-24</td><td className="text-center">8</td><td className="text-center">2.07</td><td className="text-center">42.11</td><td className="text-center">0.88</td></tr>
        <tr><td>DWavL-S-16</td><td className="text-center">6</td><td className="text-center"><b>3.77</b></td><td className="text-center"><b>10.53</b></td><td className="text-center"><u>0.89</u></td></tr>
        <tr><td>WT-SMA-24</td><td className="text-center">1</td><td className="text-center">2.74</td><td className="text-center">16.67</td><td className="text-center">0.87</td></tr>
      </tbody>
    </table>

    <div className="text-base text-gray-700 dark:text-gray-900 max-w-4xl mx-auto text-left bg-gray-50 p-4 rounded mt-6">
      <span className="text-xl mr-2">💡</span>
      Overall, achieving strong TTS performance with discrete tokenizers remains challenging, especially under constrained training conditions. Training with semantic tokenizers leads to more robust and effective TTS performance compared to acoustic or traditional tokenizers. The results highlight the advantage of preserving high-level semantic information in speech representations, both for generating natural-sounding speech and for maintaining fidelity to the target speaker and textual prompt. In contrast, acoustic tokenizers are more sensitive to model and data scaling; achieving competitive results with them typically requires larger training datasets and more complex architectures.    </div>
  </div>
</details>
  ...
  <div className="overflow-x-auto p-4 bg-white text-black mt-4">
    ...
    <div className="text-base text-gray-700 dark:text-gray-900 max-w-4xl mx-auto text-left bg-gray-50 p-4 rounded mt-6">
      <span className="text-xl mr-2">💡</span>
      Our results show the importance of training the audio tokenizer on in-domain data, suggesting that only training the audio LM on the domain does not suffice. This is evident as the tokenizer trained only on music performs poorly across all benchmarks, and the one trained only on audio has leading performance. Our results also show that best reconstruction performance does not correlate with the best modeling performance, as demonstrated by DAC-SMA-44. This could be due to the higher token rate resulting in longer sequences, or to issues specific to DAC. In the future, we encourage the community to develop modeling metrics which decouple the modeling abilities from vocoding abilities, like in the speech domain, and further investigate robust metrics.
    </div>
  </div>
</details>
  ...
  <div className="overflow-x-auto p-4 bg-white text-black mt-4">
    ...
    <div className="text-base text-gray-700 dark:text-gray-900 max-w-4xl mx-auto text-left bg-gray-50 p-4 rounded mt-6">
      <span className="text-xl mr-2">💡</span>
      On the music generation task, we observed (1) a general advantage of multi-layer codecs over the single-layer type (e.g., Wavtokenizer), which may also relate to bitrate; (2) tokenizers trained with higher sample rate data (Enc-M-32 and DAC-SMA-44) generally lead to better performance; and (3) under our setup, unconditional generation performs better across all metrics, highlighting the benefits of using prompts in music generation.
    </div>
  </div>
</details>
      </div>
